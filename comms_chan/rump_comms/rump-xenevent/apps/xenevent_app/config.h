...
// most of them will be in a wait state most of the time.
//
...
#define REQUEST_HEADER_SIZE 200
#define BUFFER_REQUEST_SIZE ( REQUEST_HEADER_SIZE + NETWORK_MTU )

#define BUFFER_REQUEST_MIN_SIZE REQUEST_HEADER_SIZE
