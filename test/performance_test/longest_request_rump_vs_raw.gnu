...
set output 'graphs/longest_raw_vs_rump.png'
...
stats 'data/rump.dat' using 1:6 prefix "RUMP"
...
plot 'data/raw.dat' using 1:6 with lines lw 3 linecolor rgb "blue" title "raw longest request (ms)",          \
     'data/rump.dat' using 1:6 with lines lw 3 linecolor rgb "red" title "rump longest request (ms)",  \
