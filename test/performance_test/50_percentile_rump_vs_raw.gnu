...
set output 'graphs/50_percentile_raw_vs_rump.png'
...
stats 'data/rump.dat' using 1:4 prefix "RUMP"
...
plot 'data/raw.dat' using 1:4 with lines lw 3 linecolor rgb "blue" title "raw ms/req",          \
     'data/rump.dat' using 1:4 with lines lw 3 linecolor rgb "red" title "rump ms/req",  \
