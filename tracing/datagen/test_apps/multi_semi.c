/*
 * multi_semi.c approximates a semi-Markov process;
 *      function sleep times are uniformly distributed, and there are no self-loops
 */
...
int fun0() {
    usleep(uniformInt(0, 200000));
    return choice(c0, SIZE);
}

int fun1() {
    usleep(uniformInt(0, 1600000));
    return choice(c1, SIZE);
}

int fun2() {
    usleep(uniformInt(0, 600000));
